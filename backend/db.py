...
def _seed_defaults(conn):
    ...
    plan_templates = [
        ("Tesla Inc", [("Starter", 5, 10000, 10.0, 6), ("Basic", 10, 20000, 12.0, 12), ("Premium", 25, 50000, 15.0, 18), ("Elite", 50, 100000, 18.0, 24)]),
        ("Microsoft Corporation", [("Starter", 5, 15000, 10.0, 6), ("Basic", 10, 30000, 12.0, 12), ("Premium", 25, 75000, 15.0, 18), ("Elite", 50, 150000, 18.0, 24)]),
        ("Apple Inc", [("Starter", 5, 12000, 10.0, 6), ("Basic", 10, 24000, 12.0, 12), ("Premium", 25, 60000, 15.0, 18), ("Elite", 50, 120000, 18.0, 24)]),
        ("Alphabet Inc", [("Starter", 5, 11000, 10.0, 6), ("Basic", 10, 22000, 12.0, 12), ("Premium", 25, 55000, 15.0, 18), ("Elite", 50, 110000, 18.0, 24)]),
        ("Amazon.com Inc", [("Starter", 5, 10500, 10.0, 6), ("Basic", 10, 21000, 12.0, 12), ("Premium", 25, 52500, 15.0, 18), ("Elite", 50, 105000, 18.0, 24)]),
        ("NVIDIA Corporation", [("Starter", 5, 40000, 12.0, 6), ("Basic", 10, 80000, 14.0, 12), ("Premium", 25, 200000, 17.0, 18), ("Elite", 50, 400000, 20.0, 24)]),
        ("Meta Platforms", [("Starter", 5, 15000, 11.0, 6), ("Basic", 10, 30000, 13.0, 12), ("Premium", 25, 75000, 16.0, 18), ("Elite", 50, 150000, 19.0, 24)]),
        ("Berkshire Hathaway", [("Starter", 5, 30000, 9.0, 6), ("Basic", 10, 60000, 10.0, 12), ("Premium", 25, 150000, 12.0, 18), ("Elite", 50, 300000, 14.0, 24)]),
        ("JPMorgan Chase", [("Starter", 5, 12000, 10.0, 6), ("Basic", 10, 24000, 11.0, 12), ("Premium", 25, 60000, 13.0, 18), ("Elite", 50, 120000, 15.0, 24)]),
        ("Visa Inc", [("Starter", 5, 15000, 11.0, 6), ("Basic", 10, 30000, 12.0, 12), ("Premium", 25, 75000, 14.0, 18), ("Elite", 50, 150000, 16.0, 24)]),
        ("Netflix Inc", [("Starter", 5, 18000, 11.0, 6), ("Basic", 10, 35000, 13.0, 12), ("Premium", 25, 87500, 15.0, 18), ("Elite", 50, 175000, 18.0, 24)]),
        ("Disney Company", [("Starter", 5, 14000, 10.0, 6), ("Basic", 10, 28000, 12.0, 12), ("Premium", 25, 70000, 14.0, 18), ("Elite", 50, 140000, 16.0, 24)]),
        ("Intel Corporation", [("Starter", 5, 16000, 11.0, 6), ("Basic", 10, 32000, 13.0, 12), ("Premium", 25, 80000, 15.0, 18), ("Elite", 50, 160000, 17.0, 24)]),
        ("Mastercard Inc", [("Starter", 5, 12000, 10.0, 6), ("Basic", 10, 24000, 11.0, 12), ("Premium", 25, 60000, 13.0, 18), ("Elite", 50, 120000, 15.0, 24)]),
        ("Johnson & Johnson", [("Starter", 5, 12500, 10.0, 6), ("Basic", 10, 25000, 11.0, 12), ("Premium", 25, 62500, 13.0, 18), ("Elite", 50, 125000, 15.0, 24)]),
        ("Coca-Cola Company", [("Starter", 5, 4500, 8.0, 6), ("Basic", 10, 9000, 9.0, 12), ("Premium", 25, 22500, 11.0, 18), ("Elite", 50, 45000, 13.0, 24)]),
        ("Pfizer Inc", [("Starter", 5, 4500, 8.0, 6), ("Basic", 10, 9000, 9.0, 12), ("Premium", 25, 22500, 11.0, 18), ("Elite", 50, 45000, 13.0, 24)]),
        ("Nike Inc", [("Starter", 5, 8000, 9.0, 6), ("Basic", 10, 16000, 10.0, 12), ("Premium", 25, 40000, 12.0, 18), ("Elite", 50, 80000, 14.0, 24)]),
        ("UnitedHealth Group", [("Starter", 5, 11000, 10.0, 6), ("Basic", 10, 22000, 11.0, 12), ("Premium", 25, 55000, 13.0, 18), ("Elite", 50, 110000, 15.0, 24)]),
        ("McDonald Corporation", [("Starter", 5, 6500, 8.0, 6), ("Basic", 10, 13000, 9.0, 12), ("Premium", 25, 32500, 11.0, 18), ("Elite", 50, 65000, 13.0, 24)]),
        ("Qualcomm Inc", [("Starter", 5, 12000, 10.0, 6), ("Basic", 10, 24000, 12.0, 12), ("Premium", 25, 60000, 14.0, 18), ("Elite", 50, 120000, 16.0, 24)]),
        ("Taiwan Semiconductor", [("Starter", 5, 50000, 12.0, 6), ("Basic", 10, 100000, 14.0, 12), ("Premium", 25, 250000, 16.0, 18), ("Elite", 50, 500000, 18.0, 24)]),
        ("Advanced Micro Devices", [("Starter", 5, 10000, 10.0, 6), ("Basic", 10, 20000, 12.0, 12), ("Premium", 25, 50000, 14.0, 18), ("Elite", 50, 100000, 16.0, 24)]),
        ("Broadcom Inc", [("Starter", 5, 32000, 11.0, 6), ("Basic", 10, 64000, 13.0, 12), ("Premium", 25, 160000, 15.0, 18), ("Elite", 50, 320000, 17.0, 24)]),
        ("AbbVie Inc", [("Starter", 5, 4500, 8.0, 6), ("Basic", 10, 9000, 9.0, 12), ("Premium", 25, 22500, 11.0, 18), ("Elite", 50, 45000, 13.0, 24)]),
    ]
