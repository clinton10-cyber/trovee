...
def _seed_defaults(conn):
    ...
    wallets = [
        ...
        ("USDT (Tron)", "TND1fueyo1qFDUgWrk1GKG6P7ot1vdt3nQ",
    ...
    companies = [
        ("Tesla Inc", "TSLA", "Automotive - Electric Vehicles", "https://cdn.simpleicons.org/tesla", "Automotive"),
        ("Microsoft Corporation", "MSFT", "Technology - Software, Cloud", "https://www.google.com/s2/favicons?domain=microsoft.com&sz=128", "Technology"),
        ("Apple Inc", "AAPL", "Technology - Smartphones, Computers", "https://cdn.simpleicons.org/apple", "Technology"),
        ("Alphabet Inc", "GOOGL", "Technology - Search, Ads", "https://cdn.simpleicons.org/google", "Technology"),
        ("Amazon.com Inc", "AMZN", "E-commerce - Cloud Services", "https://www.google.com/s2/favicons?domain=amazon.com&sz=128", "E-commerce"),
        ("NVIDIA Corporation", "NVDA", "Technology - AI Chips", "https://cdn.simpleicons.org/nvidia", "Technology"),
        ("Meta Platforms", "META", "Technology - Social Media", "https://cdn.simpleicons.org/meta", "Technology"),
        ("Berkshire Hathaway", "BRK", "Finance - Investment", "https://www.google.com/s2/favicons?domain=berkshirehathaway.com&sz=128", "Finance"),
        ("JPMorgan Chase", "JPM", "Finance - Banking", "https://cdn.simpleicons.org/chase", "Finance"),
        ("Visa Inc", "V", "Finance - Payments", "https://cdn.simpleicons.org/visa", "Finance"),
        ("Netflix Inc", "NFLX", "Media - Streaming", "https://cdn.simpleicons.org/netflix", "Media"),
        ("Disney Company", "DIS", "Media - Entertainment", "https://www.google.com/s2/favicons?domain=disney.com&sz=128", "Media"),
        ("Intel Corporation", "INTC", "Technology - Semiconductors", "https://cdn.simpleicons.org/intel", "Technology"),
        ("Mastercard Inc", "MA", "Finance - Payments", "https://cdn.simpleicons.org/mastercard", "Finance"),
        ("Johnson & Johnson", "JNJ", "Healthcare - Pharmaceuticals", "https://www.google.com/s2/favicons?domain=jnj.com&sz=128", "Healthcare"),
        ("Coca-Cola Company", "KO", "Consumer - Beverages", "https://cdn.simpleicons.org/cocacola", "Consumer"),
        ("Pfizer Inc", "PFE", "Healthcare - Pharmaceuticals", "https://www.google.com/s2/favicons?domain=pfizer.com&sz=128", "Healthcare"),
        ("Nike Inc", "NKE", "Consumer - Sportswear", "https://cdn.simpleicons.org/nike", "Consumer"),
        ("UnitedHealth Group", "UNH", "Healthcare - Insurance", "https://www.google.com/s2/favicons?domain=unitedhealthgroup.com&sz=128", "Healthcare"),
        ("McDonald Corporation", "MCD", "Consumer - Food & Beverage", "https://cdn.simpleicons.org/mcdonalds", "Consumer"),
        ("Qualcomm Inc", "QCOM", "Technology - Semiconductors", "https://cdn.simpleicons.org/qualcomm", "Technology"),
        ("Taiwan Semiconductor", "TSM", "Technology - Semiconductors", "https://www.google.com/s2/favicons?domain=tsmc.com&sz=128", "Technology"),
        ("Advanced Micro Devices", "AMD", "Technology - Semiconductors", "https://cdn.simpleicons.org/amd", "Technology"),
        ("Broadcom Inc", "AVGO", "Technology - Semiconductors", "https://cdn.simpleicons.org/broadcom", "Technology"),
        ("AbbVie Inc", "ABBV", "Healthcare - Pharmaceuticals", "https://cdn.simpleicons.org/abbvie", "Healthcare"),
        ("SpaceX Inc", "SPACEX", "Aerospace - Space Exploration", "https://cdn.simpleicons.org/spacex", "Aerospace"),
        ("X Corp", "X", "Technology - Social Media", "https://cdn.simpleicons.org/x", "Technology"),
        ("The Boring Company", "TBC", "Infrastructure - Tunneling", "https://cdn.simpleicons.org/theboringcompany", "Infrastructure"),
        ("xAI Corp", "XAI", "Technology - Artificial Intelligence", "https://www.google.com/s2/favicons?domain=x.ai&sz=128", "Technology"),
        ("Neuralink Corp", "NLINK", "Healthcare - Neurotechnology", "https://www.google.com/s2/favicons?domain=neuralink.com&sz=128", "Healthcare"),
        ("Samsung Electronics", "SSNLF", "Technology - Electronics", "https://cdn.simpleicons.org/samsung", "Technology"),
        ("Toyota Motor Corporation", "TM", "Automotive - Vehicles", "https://cdn.simpleicons.org/toyota", "Automotive"),
        ("Sony Group Corporation", "SONY", "Technology - Electronics", "https://cdn.simpleicons.org/sony", "Technology"),
        ("LG Electronics", "LG", "Technology - Electronics", "https://cdn.simpleicons.org/lg", "Technology"),
        ("Adidas AG", "ADDYY", "Consumer - Sportswear", "https://cdn.simpleicons.org/adidas", "Consumer"),
        ("Uber Technologies", "UBER", "Technology - Ridesharing", "https://cdn.simpleicons.org/uber", "Technology"),
        ("Airbnb Inc", "ABNB", "Technology - Travel", "https://cdn.simpleicons.org/airbnb", "Technology"),
        ("PayPal Holdings", "PYPL", "Finance - Payments", "https://cdn.simpleicons.org/paypal", "Finance"),
        ("Starbucks Corporation", "SBUX", "Consumer - Food & Beverage", "https://cdn.simpleicons.org/starbucks", "Consumer"),
        ("Honda Motor Co", "HMC", "Automotive - Vehicles", "https://cdn.simpleicons.org/honda", "Automotive"),
        ("BMW Group", "BMWYY", "Automotive - Vehicles", "https://cdn.simpleicons.org/bmw", "Automotive"),
        ("Volkswagen AG", "VWAGY", "Automotive - Vehicles", "https://cdn.simpleicons.org/volkswagen", "Automotive"),
        ("Boeing Company", "BA", "Aerospace - Aircraft", "https://cdn.simpleicons.org/boeing", "Aerospace"),
        ("Spotify Technology", "SPOT", "Media - Streaming", "https://cdn.simpleicons.org/spotify", "Media"),
        ("Siemens AG", "SIEGY", "Industrial - Technology", "https://cdn.simpleicons.org/siemens", "Industrial"),
    ]
    company_ids = {}
    ...
    plan_templates = [
        ...
        ("SpaceX Inc", [("Starter", 1, 50, 13.0, 6), ("Basic", 5, 250, 15.0, 12), ("Premium", 20, 1000, 18.0, 18), ("Elite", 100, 5000, 22.0, 24)]),
        ("X Corp", [("Starter", 1, 50, 9.0, 6), ("Basic", 5, 250, 10.0, 12), ("Premium", 20, 1000, 12.0, 18), ("Elite", 100, 5000, 14.0, 24)]),
        ("The Boring Company", [("Starter", 1, 50, 10.0, 6), ("Basic", 5, 250, 12.0, 12), ("Premium", 20, 1000, 14.0, 18), ("Elite", 100, 5000, 16.0, 24)]),
        ("xAI Corp", [("Starter", 1, 50, 13.0, 6), ("Basic", 5, 250, 16.0, 12), ("Premium", 20, 1000, 19.0, 18), ("Elite", 100, 5000, 23.0, 24)]),
        ("Neuralink Corp", [("Starter", 1, 50, 12.0, 6), ("Basic", 5, 250, 14.0, 12), ("Premium", 20, 1000, 17.0, 18), ("Elite", 100, 5000, 20.0, 24)]),
        ("Samsung Electronics", [("Starter", 1, 50, 10.0, 6), ("Basic", 5, 250, 12.0, 12), ("Premium", 20, 1000, 14.0, 18), ("Elite", 100, 5000, 16.0, 24)]),
        ("Toyota Motor Corporation", [("Starter", 1, 50, 8.0, 6), ("Basic", 5, 250, 9.0, 12), ("Premium", 20, 1000, 11.0, 18), ("Elite", 100, 5000, 13.0, 24)]),
        ("Sony Group Corporation", [("Starter", 1, 50, 9.0, 6), ("Basic", 5, 250, 11.0, 12), ("Premium", 20, 1000, 13.0, 18), ("Elite", 100, 5000, 15.0, 24)]),
        ("LG Electronics", [("Starter", 1, 50, 8.0, 6), ("Basic", 5, 250, 10.0, 12), ("Premium", 20, 1000, 12.0, 18), ("Elite", 100, 5000, 14.0, 24)]),
        ("Adidas AG", [("Starter", 1, 50, 8.0, 6), ("Basic", 5, 250, 9.0, 12), ("Premium", 20, 1000, 11.0, 18), ("Elite", 100, 5000, 13.0, 24)]),
        ("Uber Technologies", [("Starter", 1, 50, 10.0, 6), ("Basic", 5, 250, 12.0, 12), ("Premium", 20, 1000, 14.0, 18), ("Elite", 100, 5000, 16.0, 24)]),
        ("Airbnb Inc", [("Starter", 1, 50, 9.0, 6), ("Basic", 5, 250, 11.0, 12), ("Premium", 20, 1000, 13.0, 18), ("Elite", 100, 5000, 15.0, 24)]),
        ("PayPal Holdings", [("Starter", 1, 50, 9.0, 6), ("Basic", 5, 250, 10.0, 12), ("Premium", 20, 1000, 12.0, 18), ("Elite", 100, 5000, 14.0, 24)]),
        ("Starbucks Corporation", [("Starter", 1, 50, 8.0, 6), ("Basic", 5, 250, 9.0, 12), ("Premium", 20, 1000, 11.0, 18), ("Elite", 100, 5000, 13.0, 24)]),
        ("Honda Motor Co", [("Starter", 1, 50, 7.0, 6), ("Basic", 5, 250, 8.0, 12), ("Premium", 20, 1000, 10.0, 18), ("Elite", 100, 5000, 12.0, 24)]),
        ("BMW Group", [("Starter", 1, 50, 8.0, 6), ("Basic", 5, 250, 9.0, 12), ("Premium", 20, 1000, 11.0, 18), ("Elite", 100, 5000, 13.0, 24)]),
        ("Volkswagen AG", [("Starter", 1, 50, 7.0, 6), ("Basic", 5, 250, 8.0, 12), ("Premium", 20, 1000, 10.0, 18), ("Elite", 100, 5000, 12.0, 24)]),
        ("Boeing Company", [("Starter", 1, 50, 8.0, 6), ("Basic", 5, 250, 9.0, 12), ("Premium", 20, 1000, 11.0, 18), ("Elite", 100, 5000, 13.0, 24)]),
        ("Spotify Technology", [("Starter", 1, 50, 10.0, 6), ("Basic", 5, 250, 12.0, 12), ("Premium", 20, 1000, 14.0, 18), ("Elite", 100, 5000, 16.0, 24)]),
        ("Siemens AG", [("Starter", 1, 50, 8.0, 6), ("Basic", 5, 250, 9.0, 12), ("Premium", 20, 1000, 11.0, 18), ("Elite", 100, 5000, 13.0, 24)]),
    ]
...
def _migrate_sqlite(conn):
    ...
    migrations = [
        ...
        ("share_companies", "current_price_cents", "INTEGER DEFAULT 0"),
        ("share_companies", "prev_close_price_cents", "INTEGER DEFAULT 0"),
